const CACHE = 'health-diary-shell-v1'
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin !== location.origin || url.pathname.startsWith('/api') || ['/events','/calendar','/analytics','/batches','/episodes','/entries','/exports','/me','/auth'].some((path) => url.pathname.startsWith(path))) return
