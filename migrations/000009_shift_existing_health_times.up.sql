-- One-time owner-approved repair: early extraction stored Europe/Moscow
-- wall-clock digits as UTC. Only semantic health times are shifted; source,
-- audit, auth and operational timestamps remain true instants.
